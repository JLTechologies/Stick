...
<head>
  ...
  $_SESSION['message'] = '';
  $id = $_GET['id'];
  $editcontact = "SELECT * FROM brandcontact WHERE brandcontactID = '$id'";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Edit Brand Contact</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <?php 
    $geteditcontact = mysqli_query($conn, $editcontact);
    if (! $geteditcontact) {
    ...
    while ($row1 = mysqli_fetch_assoc($geteditcontact)) {
        ...
        $contactzipcode = htmlspecialchars($row1['zipcode']);
        $contactcity = htmlspecialchars($row1['city']);
        $contactstate = htmlspecialchars($row1['state']);
    }
    ?>
    <div class="content">
              ...
              <form action="./index.php" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="addition" name="contact_addition" placeholder="<?php echo $contactaddition;?>">
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary btn-block" name="contactupdate">Update contact</button>
                </div>
              </form>
            </div>
          </div>
